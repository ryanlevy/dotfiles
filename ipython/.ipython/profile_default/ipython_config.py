...
#  fruity, lovelace, colorful, paraiso-dark, friendly, monokai, igor, manni,
#  pastie, algol, emacs, trac, tango, autumn, bw, vs, algol_nu, native, borland,
#  murphy, xcode, perldoc, rrt, vim, default
